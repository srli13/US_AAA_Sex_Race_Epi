...
svy: logit i10_dx1_aaa_rupture i.race_model  female age i.zipinc_qrtl cm_dm_bin cm_perivasc cm_htn_c cm_chrnlung cm_smoke_notelixhuaser  cm_ctdz_notelixhauser   i.year  i.hosp_region  if age>=18 , nolog or 
	...
	************************
	 log using "/Users/katiereitz/OneDrive - UPMC/UPMC Research/NIS/PART 2/Logs/AAA NIS Logistic regression for AAA hopsitalization -- RUPTURE and INTACT LOG REG - age cat.log", replace
...
**HAD To fix the quartiles... i didnt code them correctly so i fixed it (now fixed below) and put it into this log file. 
...
************************
************************
*PREDICTING MORTALITY - subgroups
************************
************************
